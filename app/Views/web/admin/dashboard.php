...
$dashboardActionUrl = base_url('admin/dashboard');
?>
...
<main class="px-4 pb-12 max-w-[1600px] mx-auto">
    ...
    <div class="no-print w-full mb-6 rounded-2xl bg-white border border-gray-200 shadow-sm p-4">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="w-full lg:w-auto overflow-x-auto">
                <form class="flex items-center gap-2 min-w-max" method="get" action="<?= esc($dashboardActionUrl) ?>">
                    ...
                    <select class="h-10 px-3 rounded-xl border-gray-300 border text-sm shadow-sm focus:border-blue-500 outline-none bg-white min-w-[200px]" name="id_trajet" title="Trajet">
                    ...
                    <a class="h-10 w-10 rounded-xl bg-white border border-gray-300 text-gray-700 flex items-center justify-center hover:bg-gray-50 transition-all shadow-sm" href="<?= esc($dashboardActionUrl) ?>" title="Réinitialiser">
    ...
    <section class="report-card bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
            ...
            <a href="<?= base_url('admin/rapports') ?>" class="text-sm text-blue-600 font-medium hover:underline flex items-center gap-1">
                Voir tout
