...
<main class="px-4 pb-12 max-w-[1600px] mx-auto">
    ...
    <div class="w-full h-[60px] mb-6 rounded-2xl flex items-center justify-between px-6 bg-white border border-gray-200 shadow-sm">
        <div class="flex items-center gap-3 h-full">
            ...
            <h2 class="text-lg font-semibold text-gray-900 tracking-tight">Gestion des Trajets</h2>
        </div>
                        ...
                        <tr id="empty-row">
                            <td colspan="7" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center gap-3 text-gray-400">
                                    ...
                                    <p class="text-sm font-medium">Aucun trajet enregistré pour le moment</p>
                                </div>
                            </td>
                        </tr>
                    <?php else : ?>
