        ...
        <div class="w-full lg:w-auto overflow-x-auto">
             ...
             <form
                ...
                <input
                    ...
                    class="flex-shrink-0 h-10 px-3 rounded-xl border border-gray-300 text-sm shadow-sm focus:border-blue-500 outline-none"
                >
                ...
                <select
                    name="id_trajet"
                    class="flex-shrink-0 h-10 px-3 rounded-xl border border-gray-300 text-sm shadow-sm focus:border-blue-500 outline-none bg-white min-w-[220px]"
                >
                    ...
                    <?php foreach ($options['trajets'] as $route): ?>
                        ...
                        <option
                            value="<?= esc($route['id_trajet']) ?>"
                            <?= $selected($filters['id_trajet'], $route['id_trajet']) ?>
                        >
                ...
                <button
                    type="submit"
                    class="flex-shrink-0 h-10 w-10 rounded-xl bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700 transition-all shadow-sm"
                >
                    <span class="material-symbols-outlined text-[20px]">
                        filter_alt
                    </span>
                ...
                <!-- Reset -->
                <a
                    href="<?= esc($reportActionUrl) ?>"
                    class="flex-shrink-0 h-10 w-10 rounded-xl bg-white border border-gray-300 text-gray-700 flex items-center justify-center hover:bg-gray-50 transition-all shadow-sm"
                >
